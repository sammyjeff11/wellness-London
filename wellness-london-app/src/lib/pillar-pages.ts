...
export const pillarPages: PillarPageConfig[] = [
  ...
  },
  {
    ...
    href: "/perform",
    label: "Perform",
    title: "Perform in London",
    metaTitle: "Perform in London | The Well Edit",
    description: "Performance-led wellness spaces in London for training support, output, recovery, mobility and high-performance routines.",
    eyebrow: "Performance support",
    intro: "For training support, high-output routines and venues that help you feel ready to move, work and perform.",
    serviceKeys: ["recovery", "cryotherapy", "cold-plunge", "breathwork"],
    keywords: ["perform", "performance", "training", "athlete", "sports", "post-gym", "mobility", "compression", "energy"],
    popularLinks: [
      { href: "/recovery-london", label: "Recovery Spaces in London", description: "A broader guide to recovery-led venues and services." },
    ...
    guidance: [
      { title: "Match the venue to your routine", text: "Post-gym recovery, event preparation and high-output work weeks may each need different levels of structure, guidance and convenience." },
      { title: "Look for repeatability", text: "Performance-led wellness works best when the venue is practical enough to revisit consistently, not just impressive once." },
      { title: "Balance intensity with recovery", text: "Cold exposure, heat and compression can feel performance-led, but the best routines also account for sleep, stress and overall recovery load." },
    ],
    faqs: [
      { question: "What does performance wellness include?", answer: "It can include recovery technology, cold exposure, cryotherapy, compression, mobility, breathwork and routines that support training or high-output lifestyles." },
      { question: "Is this only for athletes?", answer: "No. The Perform pillar is for anyone looking for structured support around energy, training, recovery and output." },
      { question: "Which treatments are most relevant?", answer: "Cryotherapy, cold plunge, compression and recovery clubs are often most relevant, depending on the venue and your goal." },
    ],
  },
  {
    slug: "reset",
