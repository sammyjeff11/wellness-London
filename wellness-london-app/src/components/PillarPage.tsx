...
export default function PillarPage({
  ...
  return (
    <main className="bg-[#fbf8f1] text-[#29241d]">
      <section className="px-5 pb-7 pt-9 sm:px-6 sm:py-16 md:py-24">
        <div className="mx-auto max-w-5xl">
          <p className="mb-4 text-[10px] uppercase tracking-[0.24em] text-[#6f6048] sm:mb-5 sm:text-[11px] sm:tracking-[0.26em]">{pillar.eyebrow}</p>
          <h1 className="font-serif text-[2.85rem] font-normal leading-[0.98] tracking-[-0.03em] sm:text-6xl md:text-7xl">
            {pillar.title}
          </h1>
          <p className="mt-5 max-w-2xl text-[15px] leading-7 text-[#5f574c] sm:mt-8 sm:text-lg sm:leading-8">{pillar.intro}</p>
        </div>
      </section>
