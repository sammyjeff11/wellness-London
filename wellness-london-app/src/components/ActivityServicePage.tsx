  ...
  return (
    <main className="min-h-screen bg-[#f4efe6] text-[#29241d]">
      ...
      <section className="px-4 pt-4 sm:px-5 md:px-8 md:pt-8">
        <div className="relative mx-auto flex min-h-[26rem] max-w-[1400px] items-end overflow-hidden bg-[#8f806b] px-5 py-8 sm:min-h-[68vh] sm:px-6 sm:py-12 md:px-14 md:py-16">
          ...
          <div className="relative max-w-4xl text-[#fbf8f1]">
            <p className="mb-4 text-[10px] uppercase leading-5 tracking-[0.24em] text-[#fbf8f1]/78 sm:mb-8 sm:text-[11px] sm:tracking-[0.3em]">Well+ / {activity.eyebrow}</p>
            <h1 className="font-serif text-[2.8rem] font-normal leading-[0.94] tracking-[-0.035em] sm:text-[4rem] sm:leading-[0.92] md:text-[7rem]">{activity.title}</h1>
            <p className="mt-4 max-w-xl text-[15px] leading-7 text-[#fbf8f1]/88 sm:mt-8 sm:text-base sm:leading-8 md:text-lg">{activity.heroText}</p>
          </div>
        </div>
      </section>
