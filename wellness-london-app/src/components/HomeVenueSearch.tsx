      ...
      <div className="flex flex-wrap gap-2">
        {links.map((link) => (
          <Link
            ...
            href={link.href}
            className="rounded-full border border-[#cfc1ad]/80 bg-[#fbf8f1]/62 px-3 py-1.5 text-xs text-[#29241d] transition hover:border-[#8d7d67] hover:bg-[#fbf8f1] sm:text-sm"
          >
            {link.label}
          </Link>
        ))}
...
export default function HomeVenueSearch({ facilities }: HomeVenueSearchProps) {
  ...
  return (
    <section className="px-5 py-5 sm:px-6 sm:py-9">
      <div className="editorial-shell overflow-hidden rounded-[1.45rem] border border-[#d8cebf]/80 bg-[#eee6d8] shadow-[0_18px_50px_rgba(41,36,29,0.045)]">
        <div className="grid gap-5 p-5 sm:p-7 md:grid-cols-[0.78fr_1.22fr] md:gap-8 md:p-8">
          <div>
            <p className="editorial-eyebrow mb-3">Well+ directory</p>
            <h2 className="font-serif text-[2rem] font-normal leading-tight tracking-[-0.04em] sm:text-5xl">
          ...
          <div className="space-y-4">
            <label className="block">
              ...
              <input
                ...
                className="w-full rounded-full border border-[#cfc1ad] bg-[#fbf8f1] px-5 py-3 text-base text-[#29241d] shadow-[inset_0_1px_0_rgba(255,255,255,0.75)] outline-none transition placeholder:text-[#8d7d67] focus:border-[#6f6048] focus:ring-2 focus:ring-[#d8cebf] sm:py-3.5"
              />
            </label>
