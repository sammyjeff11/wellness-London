  ...
  return (
    <section className="px-5 py-5 sm:px-6 sm:py-9">
      <div className="editorial-shell overflow-hidden rounded-[1.35rem] border border-[#d8cebf]/80 bg-[#eee6d8] shadow-[0_18px_50px_rgba(41,36,29,0.045)] sm:rounded-[1.55rem]">
        <div className="grid gap-6 p-5 sm:p-7 md:grid-cols-[0.9fr_1.1fr] md:items-center md:gap-8 md:p-8 lg:gap-10">
          <div className="max-w-md md:pr-2">
            <p className="editorial-eyebrow mb-3">Well+ directory</p>
            <h2 className="font-serif text-[2rem] font-normal leading-[1.03] tracking-[-0.045em] sm:text-[2.55rem] md:text-[3rem]">
              Find your next London wellness space.
            </h2>
            <p className="mt-3 text-sm leading-6 text-[#5f574c] sm:mt-4 sm:text-[15px] sm:leading-7">
