...
export const metadata: Metadata = {
  title: "Best Cold Plunge & Ice Baths in London | Well Edit",
  description:
    "Discover curated cold plunge, ice bath and contrast therapy spaces in London, with guidance on pricing, facilities, beginner support and sauna pairings.",
