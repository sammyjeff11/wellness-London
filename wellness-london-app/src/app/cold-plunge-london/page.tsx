    ...
    <main className="min-h-screen bg-[#f8f5ef] text-[#211d18]">
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            ...
            <div className="flex gap-4 text-sm font-medium">
              ...
              <Link href="/sauna-london" className="underline">Explore saunas</Link>
            </div>
          </div>
      ...
      <section className="border-t border-stone-200 px-6 py-20">
        <div className="mx-auto max-w-3xl space-y-5 text-stone-600 leading-8">
          ...
          <p>Cold plunge has become part of the capital&apos;s modern recovery culture because it feels clear, focused and time-efficient. The strongest spaces combine cold immersion with calm interiors, staff guidance and facilities that make the session feel considered.</p>
          <p>For many people, the appeal is contrast: heat, cold, breath and stillness arranged into a simple reset. London studios are increasingly building that ritual into spaces designed for repeat weekly use.</p>
        </div>
      </section>

      <section className="border-t border-stone-200 px-6 py-20">
        <div className="mx-auto max-w-6xl">
          <h2 className="mb-8 text-4xl font-semibold tracking-tight">How to choose cold plunge in London</h2>
