...
export default async function HbotLondonPage() {
  ...
  const relatedLinks = [...internalLinks, ...buildServiceLocationLinks(hbotFacilities, "HBOT")];
  ...
  return (
    <main className="min-h-screen bg-[#f4efe6] text-[#29241d]">
      ...
      <section className="border-y border-[#cbbda9] bg-[#29241d] px-5 py-16 text-[#fbf8f1] sm:px-6 sm:py-24">
        <div className="mx-auto max-w-6xl">
          <p className="mb-4 text-[11px] uppercase tracking-[0.24em] text-[#d8cebf]">How to compare</p>
          <h2 className="mb-12 max-w-3xl font-serif text-4xl font-normal leading-tight sm:text-5xl">How to compare HBOT providers in London</h2>
      ...
      <section className="bg-[#fbf8f1] px-5 py-16 sm:px-6 sm:py-24">
        <div className="mx-auto max-w-6xl">
          <div className="mb-8 border-b border-[#d8cebf] pb-5">
            ...
            <h2 className="text-2xl font-medium tracking-normal sm:text-3xl">Related guides</h2>
          </div>
