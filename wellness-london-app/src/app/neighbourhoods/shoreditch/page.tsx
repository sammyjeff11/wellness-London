...
> = {
  ...
  "and-soul-shoreditch": {
    ...
    summary:
      "Sauna and cold plunge alongside Reformer Pilates, hot yoga, strength and a café.",
  ...
  "soho-house-shoreditch-house": {
    ...
    summary:
      "Gym, spa treatments, classes and rooftop swimming inside a members' club.",
      ...
      },
      {
        ...
        itemListElement: [
          ...
          },
          {
            ...
            position: 3,
            name: "East London",
            item: absoluteUrl("/east-london-wellness"),
          },
          {
            "@type": "ListItem",
            position: 4,
            name: "Shoreditch",
            item: absoluteUrl("/neighbourhoods/shoreditch"),
          },
        ],
      },
    ],
...
export default async function ShoreditchNeighbourhoodPage() {
  ...
  const facilities = getFacilitiesForNeighbourhood(
    allFacilities,
    "Shoreditch",
  ).sort(
    (a, b) =>
  ...
  const guidedFacilities = facilities.filter(
    (facility) => venueGuidance[facility.slug],
  );
    ...
    <main className="min-h-screen bg-[#f4efe6] text-[#29241d]">
      ...
      <section className="px-5 py-7 sm:px-6 sm:py-10">
        <div className="mx-auto max-w-6xl">
          ...
          <h1 className="max-w-5xl font-serif text-5xl font-normal leading-[0.94] tracking-[-0.05em] sm:text-6xl">
            Sauna, cold plunge and wellness in Shoreditch.
          </h1>
          <p className="mt-7 max-w-3xl text-base leading-8 text-[#5f574c] sm:text-lg">
            Shoreditch is one of London&apos;s clearest clusters for modern
            contrast therapy: shared saunas, cold-water immersion, guided
            heat-and-cold sessions and movement studios built around regular use
            rather than an occasional spa day.
          </p>
        </div>
      </section>
      ...
      {guidedFacilities.length > 0 ? (
        <section
          className="px-5 py-12 sm:px-6 sm:py-16"
          aria-labelledby="shoreditch-format-heading"
        >
          <div className="mx-auto max-w-6xl">
            <div className="mb-8 grid gap-4 md:grid-cols-[0.75fr_1.25fr] md:items-end">
              <div>
                ...
                <h2
                  id="shoreditch-format-heading"
                  className="font-serif text-4xl font-normal leading-none tracking-[-0.04em] sm:text-5xl"
                >
              ...
              <p className="max-w-2xl text-sm leading-7 text-[#5f574c] md:justify-self-end sm:text-base">
                A long facilities list does not tell you whether a venue will
                feel right. Start with the format you want, then compare price,
                access and location.
              </p>
            </div>
            ...
            <div className="grid gap-4 lg:grid-cols-3">
              {guidedFacilities.map((facility) => {
                ...
                return (
                  <article
                    key={facility.slug}
                    className="surface-paper flex h-full flex-col rounded-[1.25rem] p-6 sm:p-7"
                  >
                    <p className="text-xs uppercase tracking-[0.22em] text-[#6f6048]">
                      {guidance.label}
                    </p>
                    ...
                    <p className="mt-4 border-t border-[#d8cebf]/75 pt-4 text-sm leading-7 text-[#5f574c]">
                      {guidance.note}
                    </p>
                    <Link
      ...
      <section
        ...
        aria-labelledby="shoreditch-comparison-heading"
      >
        <div className="mx-auto max-w-6xl">
          <div className="mb-8 max-w-3xl">
            <p className="editorial-eyebrow mb-3">At a glance</p>
            <h2
              id="shoreditch-comparison-heading"
              className="font-serif text-4xl font-normal leading-none tracking-[-0.04em] sm:text-5xl"
            >
          ...
          <div className="overflow-x-auto rounded-[1.25rem] border border-[#d8cebf]/80 bg-[#f4efe6]">
            <table className="w-full min-w-[760px] border-collapse text-left">
              <thead>
                <tr className="border-b border-[#d8cebf]/80 text-xs uppercase tracking-[0.2em] text-[#6f6048]">
              ...
              <tbody>
                {facilities.map((facility) => (
                  <tr
                    key={facility.slug}
                    className="border-b border-[#d8cebf]/65 last:border-b-0"
                  >
                    ...
                    <td className="px-5 py-5 align-top text-sm leading-6 text-[#5f574c]">
                      {formatServices(facility)}
                    </td>
                    <td className="px-5 py-5 align-top text-sm leading-6 text-[#5f574c]">
                      {formatAccess(facility)}
                    </td>
                    <td className="px-5 py-5 align-top text-sm leading-6 text-[#5f574c]">
          ...
          <p className="mt-4 text-xs leading-6 text-[#6f6048]">
            Prices, timetables and access rules can change. Use the venue
            profile as a starting point and confirm the live booking details
            before travelling.
          </p>
        </div>
      </section>
          ...
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {facilities.map((facility) => (
              <FacilityCard
                key={facility.slug}
                facility={facility}
                source="neighbourhood_shoreditch_deep_guide"
              />
            ))}
          </div>
        </div>
      ...
      <section className="surface-band-sage px-5 py-12 sm:px-6 sm:py-16">
        <div className="mx-auto grid max-w-6xl gap-5 md:grid-cols-2">
          <article className="surface-paper rounded-[1.25rem] p-6 sm:p-8">
            ...
            <h2 className="font-serif text-3xl font-normal leading-none tracking-[-0.035em]">
              Start with the cold-water format.
            </h2>
            <p className="mt-4 text-sm leading-7 text-[#5f574c] sm:text-base">
              Cold plunge, ice bath and cold-water immersion often describe the
              same broad practice. What matters when choosing a venue is the
              actual temperature, the number and size of tubs, whether guidance
              is available and whether cold access is sold alone or alongside
              sauna.
            </p>
            <Link
            ...
            >
              Compare cold plunge venues in London →
            </Link>
          </article>
          ...
          <article className="surface-paper rounded-[1.25rem] p-6 sm:p-8">
            ...
            <p className="mt-4 text-sm leading-7 text-[#5f574c] sm:text-base">
              Self-led sessions give you more control over timing and intensity.
              Guided classes add breathwork, pacing and group facilitation.
              Neither is automatically better; the right choice depends on your
              experience and what you want from the visit.
            </p>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="grid gap-4 lg:grid-cols-3">
            ...
            <article className="surface-paper rounded-[1.25rem] p-6 sm:p-8">
              ...
              <p className="text-sm leading-7 text-[#5f574c] sm:text-base sm:leading-8">
                Check whether the session is guided or self-led, whether
                swimwear and advance booking are required, what towels and
                changing facilities are included, and whether access is public
                or membership-based.
              </p>
            </article>
          </div>
      ...
      <section
        className="px-5 py-12 sm:px-6 sm:py-16"
        aria-labelledby="shoreditch-faq-heading"
      >
        <div className="surface-paper mx-auto max-w-4xl rounded-[1.25rem] p-6 sm:p-9">
          ...
          <h2
            id="shoreditch-faq-heading"
            className="font-serif text-4xl font-normal leading-none tracking-[-0.04em] sm:text-5xl"
          >
            Shoreditch wellness FAQs.
          </h2>
          <div className="mt-8 divide-y divide-[#d8cebf]/75">
            {faqs.map((item) => (
              ...
              >
                ...
                <p className="mt-3 text-sm leading-7 text-[#5f574c] sm:text-base sm:leading-8">
                  {item.answer}
                </p>
              </article>
            ))}
      ...
      <section className="px-5 pb-14 sm:px-6 sm:pb-18">
        <div className="mx-auto flex max-w-6xl flex-wrap gap-3 border-t border-[#d8cebf]/80 pt-8">
          <Link
            href="/sauna-london"
            className="rounded-full border border-[#d8cebf] px-4 py-2 text-sm transition hover:bg-[#fbf8f1]"
          >
            Saunas in London
          </Link>
          <Link
