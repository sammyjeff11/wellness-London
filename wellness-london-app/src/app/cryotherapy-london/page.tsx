    ...
    <main className="min-h-screen bg-[#f4efe6] text-[#29241d]">
      ...
      <section className="px-6 py-24 md:py-32">
        <div className="mx-auto grid max-w-6xl gap-12 md:grid-cols-[0.18fr_0.72fr_1.1fr]">
          ...
          <h2 className="font-serif text-5xl font-normal leading-tight md:text-7xl">Why cryotherapy now</h2>
          <div className="space-y-6 text-lg leading-9 text-[#5f574c]">
            <p>Cryotherapy has moved from niche sports recovery into broader wellness routines.</p>
            <p>The best studios pair clinical clarity with a calm, premium environment.</p>
          </div>
        </div>
      </section>
