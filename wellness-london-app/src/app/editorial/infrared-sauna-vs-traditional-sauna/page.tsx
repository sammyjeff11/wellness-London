...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Infrared vs Traditional Sauna London | Well+ Editorial",
    description:
      "Compare infrared and traditional sauna bookings by heating method, privacy, session length and included facilities.",
...
const articleJsonLd = {
  ...
  mainEntityOfPage: absoluteUrl(
    "/editorial/infrared-sauna-vs-traditional-sauna",
  ),
  about: [
    "Infrared sauna",
    "Traditional sauna",
...
const comparisonRows = [
  {
    label: "Intensity",
    text: "Ask for the cabin temperature and booking duration. The heating method alone does not establish how comfortable a session will be for you.",
  },
  {
    label: "Setting",
    text: "Check whether the room is private or shared, its capacity and any quiet-session rules. Either heating method can appear in different settings.",
  },
  {
    label: "Inclusions",
    text: "Confirm whether cold plunge, showers, towels and changing time are included. These are venue and ticket details, not properties of the heating method.",
  },
  {
    label: "First visit",
    text: "Ask what screening and briefing are provided. A private cabin or lower advertised temperature does not establish personal suitability.",
  },
];
      ...
      <article>
            ...
            <div className="mt-16 grid gap-10 lg:grid-cols-[1.12fr_0.88fr] lg:items-end">
              ...
              <div className="border-t border-[#fbf8f1]/16 pt-5 lg:border-l lg:border-t-0 lg:pl-8 lg:pt-0">
                <p className="max-w-md text-lg leading-8 text-[#fbf8f1]/74 sm:text-xl sm:leading-9">
                  Compare the heating method, room occupancy, session length and
                  facilities included in a London sauna booking.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="px-5 py-14 sm:px-6 sm:py-20">
          <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[0.32fr_0.68fr]">
            <aside>
              <p className="text-[11px] uppercase tracking-[0.24em] text-[#8d7d67]">
                Editorial note
              </p>
            </aside>
            <div className="max-w-3xl">
              <p className="font-serif text-3xl font-normal leading-[1.16] tracking-[-0.02em] text-[#29241d] sm:text-4xl">
                Heating method and booking format are separate decisions.
                Compare both before choosing a venue.
              </p>
              <p className="mt-4 text-sm leading-7">
                Heating-method reference:{" "}
                <a
                  href="https://www.mayoclinic.org/healthy-lifestyle/consumer-health/expert-answers/infrared-sauna/faq-20057954"
                  target="_blank"
                ...
                . This article compares booking details; it is not a first-hand
                venue review.
              </p>
              <div className="mt-8 space-y-6 text-base leading-8 text-[#5f574c] sm:text-lg sm:leading-9">
                <p>
                  Traditional sauna heats the surrounding air; infrared sauna
                  uses infrared emitters to heat the body more directly. That
                  distinction does not establish privacy, noise level, treatment
                  quality or a health benefit from a particular booking.
                </p>
                <p>
                  Look at the individual session listing for temperature,
                  duration, occupancy and facilities. Ask the venue about
          ...
          <div className="mx-auto max-w-6xl border-y border-[#29241d]/18 py-8">
            ...
            <div className="grid gap-px overflow-hidden rounded-[1.4rem] border border-[#d8cebf]/80 bg-[#d8cebf]/80 md:grid-cols-2">
              <div className="bg-[#fbf8f1] p-6 sm:p-7">
                <p className="mb-8 text-[11px] uppercase tracking-[0.24em] text-[#8d7d67]">
                  Private booking
                </p>
                <h3 className="font-serif text-4xl font-normal leading-[1] tracking-[-0.02em]">
                  Check exclusive use.
                </h3>
                <p className="mt-5 text-base leading-8 text-[#5f574c]">
                  Check whether the entire cabin is reserved for you, how many
                  people the ticket covers and whether the changing area is
                  shared. Do not infer privacy from the word infrared.
                </p>
              </div>
              ...
              <div className="bg-[#fbf8f1] p-6 sm:p-7">
                ...
                <p className="mt-5 text-base leading-8 text-[#5f574c]">
                  Check whether the booking includes a cold plunge, its location
                  and any separate charges or time limits. A sauna listing alone
                  does not establish cold-water access.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-6xl">
            ...
            <div className="divide-y divide-[#29241d]/18 border-y border-[#29241d]/18">
              {comparisonRows.map((row) => (
                <div
                  key={row.label}
                  className="grid gap-4 py-6 sm:grid-cols-[0.26fr_0.74fr] sm:py-7"
                >
                  <h3 className="font-serif text-3xl font-normal leading-[1] tracking-[-0.02em]">
                    {row.label}
                  </h3>
                  <p className="max-w-3xl text-base leading-8 text-[#5f574c] sm:text-lg sm:leading-9">
                    {row.text}
                  </p>
                </div>
              ))}
        ...
        <section className="px-5 pb-16 pt-6 sm:px-6 sm:pb-24">
          <div className="mx-auto grid max-w-6xl gap-8 rounded-[2rem] bg-[#29241d] p-6 text-[#fbf8f1] sm:p-8 lg:grid-cols-[0.32fr_0.68fr]">
            <div>
              <p className="text-[11px] uppercase tracking-[0.24em] text-[#fbf8f1]/58">
                Continue exploring
              </p>
            </div>
            <div>
              ...
              <div className="mt-9 flex flex-wrap gap-3">
                <Link
                  ...
                  className="rounded-full border border-[#fbf8f1]/22 px-4 py-2 text-sm text-[#fbf8f1] transition hover:bg-[#fbf8f1] hover:text-[#29241d]"
                >
                  Explore infrared sauna
                </Link>
                <Link
                  href="/sauna-london"
                  className="rounded-full border border-[#fbf8f1]/22 px-4 py-2 text-sm text-[#fbf8f1] transition hover:bg-[#fbf8f1] hover:text-[#29241d]"
                >
                  Explore sauna directory
                </Link>
                <Link
