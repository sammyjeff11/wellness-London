...
function getCuratedPicks(facilities: ServiceDirectoryFacility[]) {
  ...
  return editorialPicks.map((pick) => {
      ...
      <article>
        ...
        <section className="px-5 pb-10 sm:px-6 sm:pb-16">
          <div className="mx-auto max-w-6xl border-y border-[#29241d]/18 py-8">
            ...
            <div className="grid gap-px overflow-hidden bg-[#29241d]/16 md:grid-cols-2">
          ...
          <div className="mx-auto grid max-w-6xl gap-8 rounded-[2rem] bg-[#29241d] p-6 text-[#fbf8f1] sm:p-8 lg:grid-cols-[0.32fr_0.68fr]">
            ...
            <div>
              ...
              <div className="mt-9 flex flex-wrap gap-3">
                ...
                <Link href="/editorial" className="rounded-full border border-[#fbf8f1]/22 px-4 py-2 text-sm text-[#fbf8f1] transition hover:bg-[#fbf8f1] hover:text-[#29241d]">All Editorial</Link>
              </div>
            </div>
          </div>
        </section>
