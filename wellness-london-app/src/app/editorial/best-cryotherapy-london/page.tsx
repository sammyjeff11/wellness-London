  ...
  return (
    <main className="min-h-screen bg-[#f4efe6] text-[#29241d]">
      ...
      <article>
        ...
        <section className="px-5 py-10 sm:px-6 sm:py-16"><div className="mx-auto max-w-6xl"><div className="mb-6 grid gap-5 lg:grid-cols-[0.32fr_0.68fr]"><p className="text-[11px] uppercase tracking-[0.24em] text-[#8d7d67]">Featured venues</p><h2 className="font-serif text-[3rem] leading-[0.92] tracking-[-0.03em] sm:text-6xl">Compare cryotherapy venues.</h2></div>{visibleVenues.map((facility, index) => <CryotherapyVenueCard key={facility.slug} facility={facility} index={index} />)}</div></section>
