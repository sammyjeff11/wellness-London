...
export const metadata: Metadata = {
  ...
  description:
    "Compare selected London wellness venues by price, access, services, facilities and booking details.",
...
export default async function ComparePage({ searchParams }: ComparePageProps) {
  ...
  return (
    <main className="min-h-screen bg-[#f4efe6] px-5 py-7 text-[#29241d] sm:px-6 sm:py-10">
      <div className="mx-auto max-w-[1400px]">
        <nav
          aria-label="Breadcrumb"
          className="mb-8 flex items-center gap-2 text-sm text-[#6f6048]"
        >
        ...
        <div className="mb-8 max-w-4xl sm:mb-10">
          ...
          <h1 className="mt-4 font-serif text-5xl font-normal leading-[0.94] tracking-[-0.05em] sm:text-6xl">
            Compare venues.
          </h1>
          <p className="mt-5 max-w-2xl text-base leading-8 text-[#5f574c] sm:text-lg">
            See the practical differences together, then open the full profile
            before booking.
          </p>
        </div>
